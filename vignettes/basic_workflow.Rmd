...
frames, except for their second column, which is called "Compound", which holds 
...
"Compound", most functions of the package will work as long as the data set have
them.
